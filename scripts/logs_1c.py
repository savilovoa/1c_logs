...
class scan_1c_logs(object):
    def __init__(self, file_name: str, info: bool=False):
                        ...
                        if len_figure == 0:
                            ...
                            if mi == 1:
                                ...
                                if not comm:
                                    ...
                                    if (mc_ch != 0) and(mc_len != 0) : 
                                        if re.fullmatch(r'.*",\d+,\n', line) != None:
                                            ...
                                            mi = 2
                                            message = message + line[:-1]
                                            mess.append(mess_multiline + line[:-1])
                                        else:
                                            logging.error('Error 1: {} \nMessage: {}'.format(line, message))
                                            break                                
                                ...
                                if mi == 4:
                                    s = s[:close_start] + '}\n'
                                message = message + s[:-1]                
                                mess_multiline = mess_multiline + s[:-1]
                            elif mi == 4:
